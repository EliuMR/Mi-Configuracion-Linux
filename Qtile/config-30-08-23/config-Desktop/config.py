...
keys = [
    ...
    #captura de pantalla
    Key([mod],"s",lazy.spawn("scrot /home/eliu/Pictures/screenshots/%Y-%m-%d-%T-screenshot.png")),
        ...
        top=bar.Bar(
            [
               ...
               # widget.Chord(chords_colors={"launch": ("#ff0000", "#ffffff"),},name_transform=lambda name: name.upper(),),
                ...
                #Info GPU
                widget.NvidiaSensors(format='GPU: T={temp}°C',foreground="#000000" ,font=fuente_barra, background="#66CCFF",**powerline2),
        		widget.Sep(linewidth=0,padding=1,foreground="#e9d0de",background=color_barra,**powerline2), #Separacion
		        
                #Info Memoria ram
                widget.Memory(format='RAM: {MemUsed: .0f}{mm}',foreground='#000000',background="#99FFFF",font=fuente_barra,update_interval=5,**powerline ), 		
                ...
                #volumen
                widget.TextBox(text="Vol:",foreground="#000000",background="#99FF99",font=fuente_barra),
                #widget.Volume(foreground="#000000",background="#99FF99",emoji=True,font=fuente_barra,**powerline),
                widget.PulseVolume(foreground="#000000",background="#99FF99",limit_max_volume=False,font=fuente_barra,**powerline),
                widget.Sep(linewidth=0,padding=1,foreground="#e9d0de",background=color_barra,**powerline), 
                ...
                #Layout
		        widget.CurrentLayout(foreground="#000000",background="#FF9999",font=fuente_barra,**powerline),
		        widget.Sep(linewidth=0,padding=1,foreground="#e9d0de",background=color_barra,**powerline), 
