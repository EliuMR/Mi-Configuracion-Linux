...
screens = [
    Screen(
		...
		#Brillo lap
		widget.TextBox(text="Brt:",foreground="#000000",background="#7DACC0",font=fuente_barra,padding_y=3),
		widget.Backlight(foreground="#000000" ,font=fuente_barra, background="#7DACC0",**powerline2,backlight_name="intel_backlight"),		
       		widget.Sep(linewidth=0,padding=1,foreground="#e9d0de",background=color_barra,**powerline2), #Separacion
